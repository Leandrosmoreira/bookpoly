...
class Writer:
    ...
    def _get_handle(self, symbol: str, date: str = None) -> IO:
        """Get or open file handle for a symbol on the given date."""
        if date is None:
